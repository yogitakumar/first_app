    ...
    return new Scaffold(
      ...
      body: Container(
        ...
        child:new Column(
          ...
          children:<Widget>[new StackedIcons(),
            new Row(
                ...
                Expanded(
                    child:Padding(
                        ...
                        child:new Container(
                            alignment:Alignment.center,
                            height:60.0,
                            //decoration:new BoxDecoration(color:Color(0xFFDF5138),borderRadius:new BorderRadius.circular(10.0)),
                            child: new Text("Forgot Password?",style: new TextStyle(fontSize:17.0,color:Color(0xFF18D191)))
                        )
                    )
                )
              ],
